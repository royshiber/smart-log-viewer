  ...
  he: {
    translation: {
      ...
      landing: {
        ...
        subtitle: 'בחר כטב״ם קיים או צור פרופיל חדש להמשך ניתוח לוגים.',
        existingTag: 'ארכיון',
        newTag: 'חדש',
      },
      dropZone: {
      ...
      logs: {
        title: 'לוגים',
        vehicleHeader: 'פלטפורמה',
        savedFlights: 'לוגים שמורים',
        empty: 'אין לוגים',
        load: 'טען',
        rename: 'שנה שם לוג',
  ...
  en: {
    translation: {
      ...
      landing: {
        ...
        subtitle: 'Pick an existing airframe or create a new profile to continue log analysis.',
        existingTag: 'Archive',
        newTag: 'New',
      },
      dropZone: {
      ...
      logs: {
        title: 'Logs',
        vehicleHeader: 'Platform',
        savedFlights: 'Saved logs',
        empty: 'No logs',
        load: 'Load',
        rename: 'Rename log',
